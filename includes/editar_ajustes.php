...
<div class="row">
    <div class="col-sm">
        <form method="post" action="<?php echo BASE_URL ?>/?p=actualizar_ajustes">
            ...
            <div class="form-group">
                <label for="mensajePresentacion">Descripción </label>
                <textarea placeholder="Descripción del Proyecto" maxlength="255"
            ...
            <div class="form-group">
                <label for="mensajeAgradecimiento">Condiciones comerciales</label>
                <textarea placeholder="Condiciones comerciales" maxlength="255"
            ...
            <div class="form-group">
                <label for="mensajePie">Observaciones</label>
                <textarea placeholder="Mensaje después del Remitente" maxlength="255"
            ...
            <a class="btn btn-success" href="<?php echo BASE_URL ?>/?p=cotizaciones">&larr; Regresa</a>
        </form>
        <br>
    </div>
</div>